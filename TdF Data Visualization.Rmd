...
The goal of this document is to play around with data from wikipedia and visualization using the 'ggplot2' package.

# Data importation and formatting

The data is scraped from the wikipedia page 'List of Tour de France general classification winners'.
